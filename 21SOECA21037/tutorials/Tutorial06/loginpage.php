        ...
        <div class="row g-0">
          ...
          <div class="col-md-6">
            ...
            <form action="loginpage.php" method="post">
              <div class="form-row">
                <div class="col-md-6">
                  <input type="Username" placeholder="Username" class="form-control my-2 p-3" name="username">
                </div>
              </div>
              <div class="form-row">
                <div class="col-md-6">
                  <input type="Password" placeholder="********" class="form-control my-2 p-3" name="password">
                </div>
              </div>
              <div class="checkbox">
                <label>
