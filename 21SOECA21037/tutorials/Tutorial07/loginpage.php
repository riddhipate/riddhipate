        ...
        <div class="row g-0">
          ...
          <div class="col-md-6">
            ...
            <form action="save.php" method="post">
              <div class="form-row">
                <div class="col-md-6">
                  <input type="Username" placeholder="Username" class="form-control my-2 p-3" name="username" value="<?=$user?>">
                </div>
              </div>
              <div class="form-row">
                <div class="col-md-6">
                  <input type="Password" placeholder="********" class="form-control my-2 p-3" name="password" value="<?=$pass?>">
                </div>
              </div>
              <div class="checkbox">
                <label>
